...
!(function (e, t) {
      ...
      (n = (function (e, t) {
        ...
        if (e)
          return "string" == typeof e
            ...
            : "Map" ===
                (u =
                  "Object" === (u = Object.prototype.toString.call(e).slice(8, -1)) && e.constructor
                    ? e.constructor.name
                    : u) || "Set" === u
            ? Array.from(e)
  ...
  function k(e, t) {
    var u = e
      ...
      n = 0;
    if (
      (u[0].trim() || u.shift(), 0 < u.length && !u[u.length - 1].trim() && u.pop(), u.length > t)
    )
      u.splice(t);
  ...
  function B(e, t, u, n) {
    ...
    return "!" !== e[0].charAt(0)
      ? ((n.state.inLink = !0),
        (e = { type: "link", raw: u, href: r, title: t, text: i, tokens: n.inlineTokens(i) }),
        (n.state.inLink = !1),
        e)
      : { type: "image", raw: u, href: r, title: t, text: c(i) };
  }
  var w = (function () {
      function e(e) {
      ...
      return (
        ...
        (t.heading = function (e) {
          ...
          if (e)
            return (
              (t = e[2].trim()),
              /#$/.test(t) &&
                ((u = E(t, "#")), (!this.options.pedantic && u && !/ $/.test(u)) || (t = u.trim())),
              {
                type: "heading",
                raw: e[0],
                depth: e[1].length,
          ...
          if (e)
            return (
              ...
              this.options.sanitize &&
                ((e = this.options.sanitizer ? this.options.sanitizer(e[0]) : c(e[0])),
                (t.type = "paragraph"),
                (t.text = e),
        ...
        (t.def = function (e) {
          ...
          if (e)
            return (
              ...
              (u = e[2]
                ? e[2].replace(/^<(.*)>$/, "$1").replace(this.rules.inline._escapes, "$1")
                : ""),
              (n =
                e[3] &&
        ...
        (t.reflink = function (e, t) {
          ...
          if ((u = (u = this.rules.inline.reflink.exec(e)) || this.rules.inline.nolink.exec(e)))
            return (e = t[(e = (u[2] || u[1]).replace(/\s+/g, " ")).toLowerCase()])
                ...
                if (D)
                  if (((o = D.length), n[3] || n[4])) s += o;
                    ...
                    return (
                      ...
                      Math.min(i, o) % 2
                        ? ((o = D.slice(1, -1)),
                          { type: "em", raw: D, text: o, tokens: this.lexer.inlineTokens(o) })
                        : ((o = D.slice(2, -2)),
                          { type: "strong", raw: D, text: o, tokens: this.lexer.inlineTokens(o) })
                    );
              }
            }
          }
        ...
        (t.codespan = function (e) {
          ...
          if (e)
            return (
              ...
              (t = /[^ ]/.test(n)),
              (u = /^ /.test(n) && / $/.test(n)),
              (n = c((n = t && u ? n.substring(1, n.length - 1) : n), !0)),
        ...
        (t.autolink = function (e, t) {
          ...
          if (e)
            return (
              (t =
                "@" === e[2]
                  ? "mailto:" + (u = c(this.options.mangle ? t(e[1]) : e[1]))
                  : (u = c(e[1]))),
              {
                type: "link",
                raw: e[0],
              ...
              (t = this.lexer.state.inRawBlock
                ? this.options.sanitize
                  ? this.options.sanitizer
                    ...
                    : c(e[0])
                  : e[0]
                : c(this.options.smartypants ? t(e[0]) : e[0])),
  ...
  function _(e) {
    for (var t, u = "", n = e.length, r = 0; r < n; r++)
      (t = e.charCodeAt(r)),
        (u += "&#" + (t = 0.5 < Math.random() ? "x" + t.toString(16) : t) + ";");
    return u;
  }
  (v._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
    ...
    (v.emStrong.rDelimAst = f(v.emStrong.rDelimAst, "g")
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v.emStrong.rDelimUnd = f(v.emStrong.rDelimUnd, "g")
      .replace(/punct/g, v._punctuation)
      .getRegex()),
    (v._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (v.reflinkSearch = f(v.reflinkSearch, "g")
  ...
  var z = (function () {
      function u(e) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm &&
            ((e.block = y.gfm), this.options.breaks ? (e.inline = v.breaks) : (e.inline = v.gfm)),
      ...
      return (
            ...
            if (
              ...
              if ((u = this.tokenizer.space(r)))
                (r = r.substring(u.raw.length)),
                  1 === u.raw.length && 0 < t.length ? (t[t.length - 1].raw += "\n") : t.push(u);
        ...
        (n.inlineTokens = function (r, t) {
          ...
          for (; null != (n = this.tokenizer.rules.inline.escapedEmSt.exec(o)); )
            (o =
              o.slice(0, n.index + n[0].length - 2) +
              "++" +
          ...
          for (; r; )
            if (
              ...
              if ((u = this.tokenizer.escape(r))) (r = r.substring(u.raw.length)), t.push(u);
                ...
                (r = r.substring(u.raw.length)),
                  (e = t[t.length - 1]) && "text" === u.type && "text" === e.type
    ...
    $ = (function () {
      ...
      return (
        ...
        (t.link = function (e, t, u) {
          return null === (e = F(this.options.sanitize, this.options.baseUrl, e))
            ? u
            : ((e = '<a href="' + e + '"'), t && (e += ' title="' + t + '"'), e + ">" + u + "</a>");
        }),
    ...
    R = (function () {
      ...
      return (
        (e.parse = function (e, t) {
          void 0 === t && (t = !0);
          for (
            var u, n, r, i, s, l, a, o, D, c, h, p, f, g, F, A, d = "", C = e.length, k = 0;
            k < C;
            k++
          )
            if (
              ...
              this.options.extensions &&
                ...
                (!1 !== (A = this.options.extensions.renderers[o.type].call({ parser: this }, o)) ||
                  ![
                    "space",
                    "hr",
                    "heading",
              ...
              switch (o.type) {
                ...
                case "table":
                  for (l = D = "", r = o.header.length, u = 0; u < r; u++)
                    l += this.renderer.tablecell(this.parseInline(o.header[u].tokens), {
                      header: !0,
                      align: o.align[u],
                    });
                  for (
                    D += this.renderer.tablerow(l), a = "", r = o.rows.length, u = 0;
                    u < r;
                    u++
                  ) {
                    for (l = "", i = (s = o.rows[u]).length, n = 0; n < i; n++)
                      l += this.renderer.tablecell(this.parseInline(s[n].tokens), {
                        header: !1,
                        align: o.align[n],
                      });
                ...
                case "list":
                  for (
                    D = o.ordered, E = o.start, c = o.loose, r = o.items.length, a = "", u = 0;
                    u < r;
                    u++
                  )
                          ...
                          ? 0 < p.tokens.length && "paragraph" === p.tokens[0].type
                            ? ((p.tokens[0].text = F + " " + p.tokens[0].text),
                              p.tokens[0].tokens &&
                                ...
                                (p.tokens[0].tokens[0].text = F + " " + p.tokens[0].tokens[0].text))
          ...
          for (var u, n, r = "", i = e.length, s = 0; s < i; s++)
            if (
              ...
              this.options.extensions &&
                ...
                (!1 !== (n = this.options.extensions.renderers[u.type].call({ parser: this }, u)) ||
                  ![
                    "escape",
                    "html",
                    "link",
  ...
  function I(e, u, n) {
    ...
    function t(e) {
      if (((e.message += "\nPlease report this to https://github.com/markedjs/marked."), u.silent))
        return "<p>An error occurred:</p><pre>" + c(e.message + "", !0) + "</pre>";
      throw e;
    }
    try {
      var a = z.lex(e, u);
  ...
  (I.options = I.setOptions =
    ...
    (I.use = function () {
      for (
        var o = I.defaults.extensions || { renderers: {}, childTokens: {} },
          e = arguments.length,
          t = new Array(e),
          u = 0;
        u < e;
