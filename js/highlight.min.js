...
var hljs = (function () {
  ...
  var te = ((t) => {
    ...
    function E(e, t, r, s) {
      ...
      function h(e, t) {
        return (
          ...
          e.beginScope &&
            (e.beginScope._wrap
              ? (M.addKeyword(S, y.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                (S = ""))
      ...
      function b(e) {
        ...
        N.endScope && N.endScope._wrap
          ...
          : s.skip
          ? (S += n)
          : (s.returnEnd || s.excludeEnd || (S += n), d(), s.excludeEnd && (S = n));
        do {
        ...
        if (((m = s), "begin" === s.type))
          return ((e) => {
            ...
            return (
              i.skip
                ? (S += t)
                : (i.excludeBegin && (S += t), d(), i.returnBegin || i.excludeBegin || (S = t)),
              h(i, e),
    ...
    function w(e) {
      ...
      const n = ((e) => {
        ...
        if (n) {
          ...
          return (
            t ||
              (W(a.replace("{}", n[1])), W("Falling back to no-highlight mode for this block.", e)),
            t ? n[1] : "no-highlight"
          );
        }
    ...
    "undefined" != typeof window &&
      ...
      Object.assign(t, {
        ...
        registerLanguage: (e, n) => {
          ...
          try {
            ...
            if ((K("Language definition for '{}' could not be registered.".replace("{}", e)), !o))
              throw t;
            K(t), (r = c);
          }
          r.name || (r.name = e),
      ...
      (t.regex = { concat: p, lookahead: d, either: f, optional: h, anyNumberOfTimes: u });
...
"object" == typeof exports &&
  ...
  (module.exports = hljs); /*! `scss` grammar compiled for Highlight.js 11.7.0 */
(() => {
  var e = (() => {
    "use strict";
    const e = [
    ...
    return (n) => {
      const a = ((e) => ({
        ...
        s = i,
        d = "@[a-z-]+",
        c = { className: "variable", begin: "(\\$[a-zA-Z-][a-zA-Z0-9_-]*)\\b", relevance: 0 };
      return {
        name: "SCSS",
        case_insensitive: !0,
        illegal: "[=/|']",
        contains: [
          ...
          { begin: "@(page|font-face)", keywords: { $pattern: d, keyword: "@page @font-face" } },
          {
            ...
            returnBegin: !0,
            keywords: { $pattern: /[a-z-]+/, keyword: "and or not only", attribute: r.join(" ") },
            contains: [
  ...
  var e = (() => {
    ...
    return (e) => {
      const n = e.regex,
        ...
        r = { className: "subst", begin: /\{/, end: /\}/, keywords: s, illegal: /#/ },
        l = { begin: /\{\{/, relevance: 0 },
        b = {
          className: "string",
          contains: [e.BACKSLASH_ESCAPE],
  ...
  var e = (() => {
    ...
    function o(o) {
      const l = o.regex,
        ...
        _ = { className: "string", begin: "`", end: "`", contains: [o.BACKSLASH_ESCAPE, y] },
        N = {
          className: "comment",
          variants: [
            o.COMMENT(/\/\*\*(?!\/)/, "\\*/", {
      ...
      const h = [].concat(N, y.contains),
        ...
        k = {
          match: l.concat(
            /\b/,
            ((O = [...c, "super", "import"]), l.concat("(?!", O.join("|"), ")")),
            d,
            l.lookahead(/\(/)
          ),
      ...
      return {
        ...
        contains: [
          ...
          },
          {
            ...
            returnBegin: !0,
            label: "func.def",
            contains: [S, o.inherit(o.TITLE_MODE, { begin: d, className: "title.function" })],
          },
          { match: /\.\.\./, relevance: 0 },
          I,
          { match: "\\$" + d, relevance: 0 },
    ...
    return (e) => {
      const t = e.regex,
        ...
        m = {
          ...
          keywords: u,
          contains: _.concat([
            { begin: /\(/, end: /\)/, keywords: u, contains: _.concat(["self"]), relevance: 0 },
          ]),
          relevance: 0,
        },
        g = {
  ...
  var e = (() => {
    ...
    return (e) => {
      const t = e.regex,
        ...
        I = { scope: "attr", match: t.concat(r, t.lookahead(":"), t.lookahead(/(?!::)/)) },
        f = {
          relevance: 0,
          begin: /\(/,
          end: /\)/,
        ...
        O = {
          ...
          match: [
            /\b/,
            t.concat("(?!fn\\b|function\\b|", u(p).join("\\b|"), "|", u(b).join("\\b|"), "\\b)"),
            r,
            t.concat(s, "*"),
            t.lookahead(/(?=\()/),
          ],
  ...
  var e = (() => {
    ...
    return (e) => {
      const i = {
        ...
        a = { className: "string", begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, i] },
        n = {
          className: "variable",
          begin: /\$\([\w-]+\s/,
          end: /\)/,
    ...
    return (e) => {
      const n = e.regex,
        ...
        u = [
          ...
          { className: "symbol", begin: ":(?!\\s)", contains: [d, { begin: a }], relevance: 0 },
          g,
          {
            className: "variable",
            begin: "(\\$\\W)|((\\$|@@?)(\\w+))(?=[^@$?])(?![A-Za-z])(?![@$?'])",
...
})(); /*! `mel` grammar compiled for Highlight.js 11.7.0 */
(() => {
  var e = (() => {
    "use strict";
    return (e) => ({
        ...
        contains: [
          {
            begin: r.either(...s),
            relevance: 0,
            keywords: { $pattern: /[\w\.]+/, keyword: c.concat(s), literal: n, type: a },
          },
          {
            className: "type",
            begin: r.either(
  ...
  var e = (() => {
    ...
    return (e) => {
      ...
      const i = {
        ...
        l = { begin: /\[/, end: /\]/, contains: [s, t, i, r, a, "self"], relevance: 0 },
    ...
    return (o) => {
      ...
      const v = [].concat(h, A.contains),
        ...
        k = {
          match: l.concat(
            /\b/,
            ((I = [...r, "super", "import"]), l.concat("(?!", I.join("|"), ")")),
            b,
            l.lookahead(/\(/)
          ),
          className: "title.function",
        ...
        contains: o.concat([
          {
            ...
            contains: [
              ...
              { className: "params", begin: "\\(", endsWithParent: !0, contains: o },
            ].concat(o),
          },
          e.C_NUMBER_MODE,
          e.APOS_STRING_MODE,
